...
public class ByteBuffer {
    ...
    public <I, T extends IByteSerializable<I>> I readObject(T value) throws IOException {
        return value.read(this);
    }

    public <I, T extends IByteSerializable<I>> I writeObject(T value) throws IOException {
