...
public class ServerListener extends Thread {
    ...
    public ServerListener(int port) {
        this.setName("[Net] Server Listener");
    ...
    private void listen() {
        try {
            while(this.isConnected() && !serverSocket.isClosed()) {
                Listener listener = new Listener().connect(this.serverSocket.accept());
